...
namespace ImposterSystem
{
	internal static class LODGroupGUI
	{
		public class GUIStyles
		{
			...
			public readonly GUIContent m_RecalculateBounds = new GUIContent("Recalculate Bounds|Recalculate bounds to encapsulate all child renderers.");

			public readonly GUIContent m_RecalculateBoundsDisabled = new GUIContent("Recalculate Bounds|Bounds are already up-to-date.");

			public readonly GUIContent m_LightmapScale = new GUIContent("Recalculate Lightmap Scale|Set the lightmap scale to match the LOD percentages.");

			public readonly GUIContent m_RendersTitle = new GUIContent("Renderers:");

			public readonly GUIContent m_AnimatedCrossFadeInvalidText = new GUIContent("Animated cross-fading is currently disabled. Please enable \"Animate Between Next LOD\" on either the current or the previous LOD.");

			public readonly GUIContent m_AnimatedCrossFadeInconsistentText = new GUIContent("Animated cross-fading is currently disabled. \"Animate Between Next LOD\" is enabled but the next LOD is not in Animated Cross Fade mode.");

			public readonly GUIContent m_AnimateBetweenPreviousLOD = new GUIContent("Animate Between Previous LOD|Cross-fade animation plays when transits between this LOD and the previous (lower) LOD.");
		}
